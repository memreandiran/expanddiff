...
Seven checkpoints, one per arm reported in the paper and the supplementary
...
linear target; it is included because the supplementary material reports it.
**ExpandDiff-S** is trained on LEDiff's degradation and is likewise reported only
in the supplementary material. The
...
`expanddiff_p_150k`, `expanddiff_b_75k`, `expanddiff_s_150k` and
`ablation_pu21_unbounded_150k`,
...
| `expanddiff_s_150k.ckpt` | **ExpandDiff-S** (supplementary) | 150000 | `169b4af446a2d0b8b507d2fdbbd3899db0be9be97a2de8e22c07a2405533de47` |
...
| **S** | `scenehdr_512` | PU21 | yes | 32 | 2e-4 | 150k |
